     ...
     <div className="main__promo">
      <div className="main__demo">
       ...
       <p className="main__demo-p">
        ...
        Технология Sagaart создана как для профессионалов, так и для новичков,
        желающих узнать стоимость любого объекта искусства. Как это работает?
        Заходи в раздел и узнавай подробности!
       </p>
      </div>
      ...
      <button className="main__demo-button">Попробовать за 300 рублей</button>
     </div>
     <div className="main__marketplace">
      ...
      <div className="main__marketplace-info">
       ...
       <p className="main__marketplace-p">
        А это наш маркеплейс, где все цены на предметы искусства рассчитаны с
        помощью нашего алгоритма. Смелее заходи и погружайся в мир искусства!
       </p>
